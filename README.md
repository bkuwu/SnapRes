...
> SnapRes is unsigned, so Windows SmartScreen may flag it on first launch. Click "More info" → "Run anyway." This is normal for small independent tools that don't pay for a code-signing certificate.
